...
void MCP2515_write_id(MCP2515_Handle handle, const uint8_t mcp_addr, const uint8_t ext, const uint32_t id);
void MCP2515_write_id_N(MCP2515_Handle handle, const uint8_t mcp_addr, const uint8_t ext, const uint32_t id);
...
// void MCP2515_setStateAfterRead(uint16_t state); // Default 1;
// #endif
