...
PAGE 0:    /* Program Memory */
   ...
   FLASHA_D    : origin = 0x3F0000, length = 0x007F7F     /* on-chip FLASH B, C and D */
...
SECTIONS
{
   ...
   .stack              : > D_RAML0      PAGE = 0
   .ebss               : > D_RAML0      PAGE = 0
   ebss_extension      : > P_RAML0      PAGE = 0
   .esysmem            : > RAMM0_M1     PAGE = 0

   rom_accessed_data   : > RAMM0_M1     PAGE = 0

   /* Initalized sections go in Flash */
   /* For SDFlash to program these, they must be allocated to page 0 */
   .econst     : LOAD = FLASHA_D,
                 RUN = RAMM0_M1,
